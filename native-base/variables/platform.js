...
const basePx = 375
const px2dp = px => (px * deviceWidth) / basePx
...
export default {
  ...
  // Color
  //:fix brandPrimary: platform === PLATFORM.IOS ? '#007aff' : '#3F51B5',
  brandPrimary: '#108EE9',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  ...
  // Font
  //fix: DefaultFontSize: 16,
  DefaultFontSize: px2dp(14),
  ...
  // Header
  // fix: toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarBtnColor: '#007aff',
  //fix: toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#3F51B5',
  ...
  // Other
  //fix: borderRadiusBase: platform === PLATFORM.IOS ? 5 : 2,
  borderRadiusBase: 3,
